...
export function LandingHero() {
  return (
    <section className="relative isolate flex min-h-[92svh] items-end overflow-hidden pb-16 pt-32 md:min-h-[88svh] md:items-center md:pb-28">
      <Image
      ...
      <div className={LANDING_CONTAINER}>
        <div className="flex w-full max-w-xl flex-col gap-7 lg:max-w-3xl">
          <h1 className="text-title font-extrabold tracking-[-0.036em] sm:text-display lg:text-[72px] lg:leading-[1.04] xl:text-[80px]">
            Encontrá con
            <br />
            quién jugar hoy.
          </h1>
          ...
          <p className="max-w-md text-callout text-ink-64">
            Partidos abiertos cerca tuyo, gente de tu nivel y la cancha ya
            reservada. Entrás, jugás, listo.
          </p>
